...
class RunningProdTasksModel(models.Model):
    ...
    inputdatasettype = models.CharField(max_length=384, db_column='inputdatasettype')
    outputdatasettype = models.CharField(max_length=400, db_column='outputdatasettype')
