...
def civiewDemo(request):
    ...
    person_icon1 = (
        '<span style="display:inline-block;" title="MASTER ROLE" class="DataTables_sort_icon ui-icon ui-icon-person">ICONP1</span>'
    )
    mailyes_icon = (
        '<span style="cursor:pointer; display:inline-block; " title="MAIL ENABLED" class="ui-icon ui-icon-mail-closed"> ICON1</span>'
    )
